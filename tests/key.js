describe('Key', function () {
    describe('set()', function () {
        ...
        it('Set a object.', function () {
            var obj = {test:'test'};
            var ok = ros.set('set.2', obj);
            assert(obj === ros.get('set.2'));
            assert(ok === true);
        });
    });
    ...
    describe('rename()', function () {
        it('Rename exist ', function () {
            ...
            assert(null === ros.get('rename.2'));
            ros.rename('rename.1', 'rename.2');
            assert(null === ros.get('rename.1'));
        ...
        it('Rename non-exist ', function () {
            ...
            assert(false === ok);
            assert(null === ros.get('rename.3'));
            assert(null === ros.get('rename.4'))
        });
    });
    ...
    describe('renamenx()', function () {
        it('Rename exist key and non-exist new ', function () {
            ...
            assert(null === ros.get('renamenx.2'));
            ros.renamenx('renamenx.1', 'renamenx.2');
            assert(null === ros.get('renamenx.1'));
        ...
        it('Rename non-exist key and new ', function () {
            ...
            assert(false === ok);
            assert(null === ros.get('renamenx.3'));
            assert(null === ros.get('renamenx.4'))
        });
