var ros = (function () {
  ...
  return {
    ...
    lrange: function (key, start, end) {
      ...
      if (end < 0) end += data[key].length;

      return data[key].slice(start, end + 1);
    },
    ...
    ltrim: function (key, start, end) {
      ...
      data[key] = data[key].slice(start, end + 1);
      return true;
    },
    ...
    zcount: function (key, start, end) {
      ...
      if (end < 0) end += sorted_list[key].length;

      return sorted_list[key].slice(start, end + 1).length;
    },
    ...
    zrange: function (key, start, end, withscores) {
      ...
      var members = sorted_list[key].slice(start, end + 1);
